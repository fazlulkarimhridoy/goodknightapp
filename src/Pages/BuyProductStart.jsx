    ...
    >
      ...
      <div className="container px-4 font-poppins">
        ...
        <div className="text-center">
          ...
          <p className="text-white mt-4 text-4xl p-2 ">
        ...
        <div className="flex justify-between gap-8 mt-40">
          <motion.button
            ...
            className="text-xl rounded-lg text-white bg-[#303030] px-8 py-2 flex justify-center items-center gap-2"
          >
            {" "}
            <ImCross />
          ...
          <Link to="/calculation">
            <motion.button
              whileTap={{ scale: 0.9 }}
              className="text-2xl rounded-lg text-white bg-[#2C9A1A] px-8 py-2 flex justify-center items-center gap-2"
            >
              {" "}
              <TiTick />
