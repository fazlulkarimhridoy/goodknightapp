...
const AmountCalculation = () => {
  const { setCustomerData, customerData, handleChange } =
      ...
      <div className="bg-[#890000]">
        <div className="container">
          ...
          <div className="flex items-center justify-center gap-3">
            <button onClick={handleQuantity1} className="btn-primary w-14 h-14">
              1
            </button>
            <h1 className="text-white text-2xl">or</h1>
            <button onClick={handleQuantity2} className="btn-primary w-14 h-14">
              2
            </button>
          </div>
          ...
          <h2 className="text-white text-4xl font-bold">BDT {amount}/-</h2>
