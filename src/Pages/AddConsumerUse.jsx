        ...
        <div className="container">
          ...
          <div className="arrow">
            <select
              ...
              id="product"
              className=" w-[220px] text-center text-black shadow-slate-300 shadow-inner px-12 py-2 text-xl font-semibold rounded-xl outline-none bg-[#D9D9D9]"
            >
          ...
          <div>
            <button
              ...
              onClick={handleChange}
              className={`btn-primary ${
                previous_used_product === "others" ? "bg-[#393939]" : ""
              }`}
            >
              Others
            </button>
